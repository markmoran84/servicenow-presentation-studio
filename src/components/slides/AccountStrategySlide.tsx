...
export const AccountStrategySlide = () => {
  ...
  const alignmentConnections = strategicOpportunities.map((opp, idx) => ({
    opportunity: opp,
    alignsTo: customerPriorities[idx % customerPriorities.length],
  }));
        ...
        <div className="flex items-start justify-between mb-8">
          <div className="opacity-0 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              Strategic focus areas aligned to {basics.accountName.split(" ").pop()}'s transformation priorities
            </p>
          </div>
        </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground max-w-2xl">
                  By aligning our capabilities directly to {basics.accountName.split(" ").pop()}'s stated priorities, 
                  we create a defensible position that competitors cannot easily replicate.
                </p>
              </div>
            </div>
