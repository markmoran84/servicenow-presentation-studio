  ...
  return (
    <div className="min-h-screen p-8 pb-32 relative">
      ...
      <div className="mb-6 opacity-0 animate-fade-in">
        <h1 className="text-5xl font-bold text-primary mb-2">Risk & Mitigation</h1>
        <p className="text-xl text-muted-foreground">Mitigation strategies for key risks</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center min-h-[400px]">
        <div className="text-center opacity-0 animate-fade-in" style={{ animationDelay: "100ms" }}>
          ...
          <p className="text-lg text-muted-foreground">Risk mitigation strategies to be defined</p>
        </div>
      </div>
    </div>
  );
