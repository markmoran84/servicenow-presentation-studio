                  ...
                  parameters: {
                    ...
                    properties: {
                      ...
                      keyExecutives: {
                        ...
                        description: "5-8 key executives with their stated priorities",
                      },
                      // Business Model Canvas fields for deep extraction
                      keyPartners: {
                        type: "array",
                        items: { type: "string" },
                        description: "Key strategic partners mentioned (suppliers, alliances, vendors)",
                      },
                      keyActivities: {
                        type: "array",
                        items: { type: "string" },
                        description: "Core business activities the company must excel at",
                      },
                      keyResources: {
                        type: "array",
                        items: { type: "string" },
                        description: "Unique assets and resources (physical, intellectual, human)",
                      },
                      valueProposition: {
                        type: "array",
                        items: { type: "string" },
                        description: "Key value propositions for customers",
                      },
                      customerRelationships: {
                        type: "array",
                        items: { type: "string" },
                        description: "Types of customer relationships described",
                      },
                      channels: {
                        type: "array",
                        items: { type: "string" },
                      ...
                      costStructure: {
                        type: "array",
                        items: { type: "string" },
                        description: "Major cost drivers with specifics if available",
                      },
                      revenueStreams: {
                        type: "array",
                        items: { type: "string" },
                        description: "Revenue streams with breakdown if available",
                      },
                      competitors: {
                        type: "array",
                        items: { type: "string" },
                        description: "Competitors mentioned in the report",
                      },
                      ...
                      boardMembers: {
                        ...
                        description: "Board members mentioned with roles",
                      },
                      strategicInitiatives: {
                        ...
                        description: "Major strategic initiatives with timelines and investments",
                      },
                      riskFactors: {
                        type: "array",
                        items: { type: "string" },
                      ...
                      capitalAllocation: {
                        type: "string",
                        description: "Capital allocation priorities and investment focus",
                      },
                      dividendPolicy: {
                        type: "string",
                        description: "Dividend policy and shareholder returns strategy",
                      },
                      employeeCount: {
                        type: "string",
                      ...
                      geographicPresence: {
                        type: "array",
                        items: { type: "string" },
                        description: "Key geographic markets and regions",
                      },
                    },
                    required: [
                      "accountName",
